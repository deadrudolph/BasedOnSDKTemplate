package com.deadrudolph.template_based_on_sdk.presentation.ui.activity
...
import com.deadrudolph.template_based_on_sdk.R
import com.deadrudolph.template_based_on_sdk.di.component.main.AppComponentHolder
import com.deadrudolph.template_based_on_sdk.navigation.host.NavigationComponent
import com.deadrudolph.template_based_on_sdk.navigation.tab.TabItem
...
internal class MainActivity : ComponentActivity(), ActivityActions {
    ...
    private fun getBottomItems(): List<TabItem> {
        return listOf(
            ...
            TabItem(
                label = com.deadrudolph.feature_settings.R.string.settings,
                icon = Icons.Default.Settings,
                route = NavigationManager.getNavTargetOrEmpty(
                    SettingsGlobalNavTarget.SETTINGS_NAV_TARGET_KEY
                ).route
            )
        )
    }
